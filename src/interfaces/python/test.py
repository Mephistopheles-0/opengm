...
class TestSubmodularGridInference:
    ...
    def runAlgTester(self, algName, optimal=False, parameter=None):
        ...
        inf = opengm.inferenceAlgorithm(
            self.gm, alg=algName, parameter=parameter)
    ...
    def test_astar(self):
        infname = 'astar'
        param = opengm.inferenceParameter(self.gm, alg=infname)
        param.set(heuristic=opengm.Heuristic.standard,
                  maxHeapSize=2000000, numberOfOpt=1)
